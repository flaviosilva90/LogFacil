object FrmCompras: TFrmCompras
  ...
  object pnlTopo: TPanel
    ...
    object lblTitulo: TLabel
      Left=12 Top=10 Caption='COMPRAS DE MAT'#201'RIA-PRIMA'
  ...
  object pnlEdicao: TPanel
    ...
    object lblFornec: TLabel Left=110 Top=8 Caption='Fornecedor: *' end
    object edtFornecID: TEdit Left=110 Top=26 Width=55 Height=25 TabOrder=1 end
    object edtFornecNome: TEdit Left=170 Top=26 Width=280 Height=25 ReadOnly=True Color=clBtnFace TabOrder=2 end
    object btnBuscarFornec: TButton Left=456 Top=25 Width=28 Height=27 Caption='...' TabOrder=3 OnClick=btnBuscarFornecClick end
    ...
    object lblPrevisao: TLabel Left=618 Top=8 Caption='Previs'#227'o' end
    object edtPrevisao: TDateTimePicker Left=618 Top=26 Width=110 Height=25 TabOrder=5 end
    ...
    object lblSerie: TLabel Left=140 Top=62 Caption='S'#233'rie' end
    object edtSerie: TEdit Left=140 Top=80 Width=60 Height=25 TabOrder=8 end
    object lblCondPagto: TLabel Left=212 Top=62 Caption='Cond. Pagamento' end
    object edtCondPagto: TEdit Left=212 Top=80 Width=200 Height=25 TabOrder=9 end
    object lblObs: TLabel Left=424 Top=62 Caption='Obs' end
    object mmoObs: TMemo Left=424 Top=80 Width=420 Height=48 TabOrder=10 end
    object lblItens: TLabel Left=8 Top=140 Caption='Itens da Compra:' Font.Style=[fsBold] ParentFont=False end
    ...
    object pnlAddItem: TPanel
      ...
      object lblAddMP: TLabel Left=8 Top=10 Caption='ID MP:' end
      object edtAddMPID: TEdit Left=48 Top=6 Width=55 Height=25 TabOrder=0 end
      object edtAddMPNome: TEdit Left=108 Top=6 Width=240 Height=25 ReadOnly=True Color=clBtnFace TabOrder=1 end
      object btnBuscarMP: TButton Left=354 Top=5 Width=28 Height=27 Caption='...' TabOrder=2 OnClick=btnBuscarMPClick end
      object lblAddQtd: TLabel Left=390 Top=10 Caption='Qtd:' end
    ...
    object pnlBotoes: TPanel
      ...
      object btnSalvar: TButton
        Left=8 Top=8 Width=100 Height=30 Caption='Salvar' TabOrder=0 OnClick=btnSalvarClick
      end
      object btnConfirmar: TButton
        Left=116 Top=8 Width=110 Height=30 Caption='Confirmar' Enabled=False TabOrder=1 OnClick=btnConfirmarClick
      end
      object btnReceber: TButton
        Left=234 Top=8 Width=110 Height=30 Caption='Receber' Enabled=False TabOrder=2 OnClick=btnReceberClick
      end
      object btnCancelarDoc: TButton
        Left=352 Top=8 Width=110 Height=30 Caption='Cancelar' Enabled=False TabOrder=3 OnClick=btnCancelarDocClick
      end
      object btnFechar: TButton
        Left=470 Top=8 Width=100 Height=30 Caption='Fechar' TabOrder=4 OnClick=btnFecharClick
      end
    end
  end
end
