object FrmClientes: TFrmClientes
  ...
  object pnlTopo: TPanel
    Left = 0  Top = 0  Width = 860  Height = 40
    Align = alTop  BevelOuter = bvNone  Color = $00993300
    object lblTitulo: TLabel
      Left = 12  Top = 10
      Caption = 'CADASTRO DE CLIENTES'
      Font.Color = clWhite  Font.Style = [fsBold]  Font.Height = -14
      ParentFont = False
    end
  end
  object pnlFiltro: TPanel
    Left = 0  Top = 40  Width = 860  Height = 44
    Align = alTop  BevelOuter = bvNone  TabOrder = 1
    object edtFiltro: TEdit
      Left = 8  Top = 10  Width = 280  Height = 25  TabOrder = 0
    end
    object chkSoAtivos: TCheckBox
      Left = 300  Top = 13  Width = 80  Caption = 'S'#243' ativos'
      Checked = True  State = cbChecked  TabOrder = 1
    end
    object btnBuscar: TButton
      Left = 390  Top = 9  Width = 80  Height = 27
      Caption = 'Buscar'  TabOrder = 2  OnClick = btnBuscarClick
    end
    object btnNovo: TButton
      Left = 480  Top = 9  Width = 80  Height = 27
      Caption = 'Novo'  TabOrder = 3  OnClick = btnNovoClick
    end
  end
  ...
  object pnlEdicao: TPanel
    Left = 0  Top = 284  Width = 860  Height = 376
    Align = alTop  BevelOuter = bvNone  Color = $00FAFAFA
    TabOrder = 3  Visible = False
    object pgcDados: TPageControl
      ...
      object tabGeral: TTabSheet
        ...
        object cboTipo: TComboBox
          Left=8  Top=28  Width=120  Height=25  Style=csDropDownList  TabOrder=0
        ...
        object lblCPF: TLabel  Left=8    Top=64  Caption='CPF' end
        object edtCPF: TEdit   Left=8    Top=82  Width=140  Height=25  MaxLength=14  TabOrder=3 end
        object lblCNPJ: TLabel Left=8    Top=64  Caption='CNPJ'  Visible=False end
        object edtCNPJ: TEdit  Left=8    Top=82  Width=160  Height=25  MaxLength=18  TabOrder=4  Visible=False end
        object lblRG: TLabel   Left=160  Top=64  Caption='RG' end
        object edtRG: TEdit    Left=160  Top=82  Width=120  Height=25  TabOrder=5 end
        object lblIE: TLabel   Left=160  Top=64  Caption='Ins. Estadual'  Visible=False end
        object edtIE: TEdit    Left=160  Top=82  Width=120  Height=25  TabOrder=6  Visible=False end
        object lblEmail: TLabel Left=8   Top=118  Caption='E-mail' end
        object edtEmail: TEdit  Left=8   Top=136  Width=240  Height=25  TabOrder=7 end
        object lblFone1: TLabel Left=260 Top=118  Caption='Fone 1' end
        object edtFone1: TEdit  Left=260 Top=136  Width=140  Height=25  TabOrder=8 end
        object lblFone2: TLabel Left=412 Top=118  Caption='Fone 2' end
        object edtFone2: TEdit  Left=412 Top=136  Width=140  Height=25  TabOrder=9 end
        object lblLimite: TLabel Left=8  Top=172  Caption='Limite de Cr'#233'dito' end
        object edtLimite: TEdit  Left=8  Top=190  Width=120  Height=25  Text='0,00'  TabOrder=10 end
        object lblAtivo: TLabel  Left=140 Top=172  Caption='Ativo' end
        object cboAtivo: TComboBox Left=140 Top=190 Width=60 Height=25 Style=csDropDownList TabOrder=11 end
      end
